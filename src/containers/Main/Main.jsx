    ...
    <main className="main">
      ...
      <div className="description">
        ...
        <ul className="description__list description__list_mobile">
          {MOBILE_LIST_ITEMS.map(el => <ListItem key={crypto.randomUUID()} title={el.title} isMobile />)}
        </ul>

        <ul className="description__list description__list_desktop">
          {DESKTOP_LIST_ITEMS.map(el => <ListItem key={crypto.randomUUID()} title={el.title} desc={el.desc} />)}
        </ul>
