    ...
    <header className="header">
      <div className="header__leftSide">
        ...
        <div className="header__links">
          {HEADER_LINKS.map(el =>
            !el.onlyDesktop
              ? <Link key={crypto.randomUUID()} text={el.title} url={el.url} type="header" />
              : <span className="header__link_desktop"><Link key={crypto.randomUUID()} text={el.title} url={el.url} type="header" /></span>
          )}
        </div>
      </div>
      <div className="header__rightSide">
        ...
        <div className="socialLinks">
          {CONTACT_LINKS.map(el =>
            <Link key={crypto.randomUUID()} icon={el.icon} url={el.url} type="icon" />
          )}
        </div>
      </div>
    </header>
